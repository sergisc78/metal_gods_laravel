    ...
    <div class="col-md-5 w-100">
      <div class="box-shadow bg-white p-4 div-form" id="addGenreform">
        ...
        <div class="text-center">
          <a href="{{url('user/bands')}}" class="btn btn-primary back-cats w-50 mx-auto mt-3 mb-3 form-back">Bands</a>
        </div>
        
        <form action="{{url('user/addBand')}}" method="post" enctype="multipart/form-data">
          @csrf
