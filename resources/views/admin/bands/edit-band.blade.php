  ...
  <div class="row-content">
    <div class="col-md-5 w-100">
      <div class="box-shadow bg-white p-4" id="addGenreform">
        <h3 class="mb-4 text-center fs-0.5 form-title">Edit Band </h3>
        ...
        <form action="{{url('admin/bands/edit-band/'.$band->id)}}" method="post" enctype="multipart/form-data">
          @csrf

          <div class="form-group mt-3 text-center">
            <label for="band" class="form-labe form-label-title mb-1">Band</label>
          ...
          <div class="form-group mt-3 text-center">
            ...
            <input class="form-control form-input-name border border-dark" type="text" name="band_year_creation"
              id="band" value={{$band->band_year_creation}} >
