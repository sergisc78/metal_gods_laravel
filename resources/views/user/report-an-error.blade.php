      ...
      <div class="box-shadow bg-white p-4 div-form" id="addGenreform">
        ...
        <div class="text-center">
          <a href="{{url('user/dashboard')}}"
            class="btn btn-primary back-cats w-50 mx-auto mt-3 mb-3 form-back">Dashboard</a>
        </div>
        <form action="{{url('user/report-an-error')}}" method="post" enctype="multipart/form-data">
          @csrf
