  ...
  <div class="row-content">
    <div class="col-md-5 w-100">
      <div class="box-shadow bg-white p-4" id="addGenreform">
        <h3 class="mb-4 text-center fs-1 form-title">Edit Genre </h3>
        ...
        <div class="text-center">
          <a href="{{url('admin/genres')}}" class="btn btn-primary back-cats w-50 mx-auto mt-3 mb-3 form-back">Genres</a>
        </div>
        <form action="{{url('admin/genres/edit-genre/'.$genre->id)}}" method="post" enctype="multipart/form-data">
          @csrf

          <div class="form-group mt-3 text-center">
            <label for="genre" class="form-label form-label-title">Genre</label>
            <input class="form-control form-input-name border border-dark" name="genre_name" id="genre_name" value="{{$genre->genre_name}}">
            @error('genre_name')
